...
namespace VstNetAudioPlugin.Dsp
{
  ...
  internal sealed class DelayParameters
  {
    ...
    public static List<int> Notes { get; set; } = new List<int>();
    public static double Saw { get; internal set; }
    public static double Attack { get; internal set; }
    public static double Release { get; internal set; }
    public static bool FmMod { get; internal set; }
